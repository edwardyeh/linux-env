...
alias git_stm="git status -s . | egrep '^ M|^MM' | awk '{print "'$2'"}'"
alias git_std="git status -s . | egrep '^ D' | awk '{print "'$2'"}'"
alias git_stu="git status -s . | egrep '^??' | awk '{print "'$2'"}'"
alias git_sta="git status -s . | egrep '^A' | awk '{print "'$2'"}'"
